...
@Composable
fun ContactoScreen(navController: NavController) { // <--- AHORA RECIBE EL NAVCONTROLLER
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Button(
            onClick = { navController.navigate("tickets") } // Navega a la ruta que definimos en MainActivity
        ) {
